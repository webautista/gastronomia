...
$stmt = db()->prepare(
    'SELECT r.*, cr.nombre AS categoria
     ...
     WHERE r.id NOT IN (SELECT receta_id FROM practica_receta WHERE practica_id = ?)
...
$activeNav = 'practicas';
$breadcrumb = '<a href="index.php">Prácticas</a> &nbsp;/&nbsp; <a href="detalle.php?id=' . $id . '">' . e($practica['nombre']) . '</a> &nbsp;/&nbsp; <b>Agregar recetas</b>';
require __DIR__ . '/../includes/layout_top.php';
?>

<div class="page-head"><div><h1>Agregar receta a la práctica</h1><p><?= e($practica['nombre']) ?> · al agregarla se usarán sus propias porciones base (puedes ajustarlo después).</p></div></div>

<div class="card card-pad form-card" style="max-width:560px;">
  <?php if (!$disponibles): ?>
    <p class="cell-muted">Todas las recetas del catálogo ya están asignadas a esta práctica.</p>
