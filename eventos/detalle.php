...
$puedeVerRecetasEnCompras = can($usuarioActual, 'eventos_lista_compra_recetas', 'ver');
    ...
    <table class="table">
      ...
      <tbody>
        <?php if (!$consolidado['lineas'] && !$consolidado['al_gusto']): ?>
          <tr><td colspan="<?= $puedeVerRecetasEnCompras ? 4 : 3 ?>" class="cell-muted" style="text-align:center;padding:24px;">Aún no hay recetas asignadas a este evento.</td></tr>
        <?php endif; ?>
